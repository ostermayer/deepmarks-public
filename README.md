...
| ---------------- | --------- | --------------- | ----- |
| `frontend/`      | passing   | 491 / 491       | SvelteKit SPA, Cloudflare Pages |
| `api/` | passing   | 474 / 474       | Fastify, hosts LNURL + /api/v1 |
| `archive-worker/`| builds    | 107 / 107 (+74 env-gated live) | Playwright + SingleFile + BUD-04 |
...
**Combined: 1,226 passing tests** + 74 env-gated archive-worker
...
- **Public source/server releases** use GitHub tags on
  `deepmarks-public`, currently the `v0.8.x` series (legacy `v2.0.x`
