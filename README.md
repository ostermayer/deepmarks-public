...
| ---------------- | --------- | --------------- | ----- |
| `frontend/`      | passing   | 466 / 466       | SvelteKit SPA, Cloudflare Pages |
| `payment-proxy/` | passing   | 406 / 406       | Fastify, hosts LNURL + /api/v1 |
| `archive-worker/`| builds    | 72 / 72 (+74 env-gated live) | Playwright + SingleFile + BUD-04 |
| `bunker/`        | passing   | 50 / 50         | NIP-46 signing service |
| `browser-extension/` | passing | 34 / 34       | Chrome/Firefox/Safari extension |
...
**Combined: 1,028 passing tests.** CI
...
- **Android, iOS, Zapstore, and browser-extension releases** use
  monotonically increasing store/package versions such as `2.2.5`.
