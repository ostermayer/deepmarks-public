...
| ---------------- | --------- | --------------- | ----- |
| `frontend/`      | passing   | 314 / 314       | SvelteKit SPA, Cloudflare Pages |
| `payment-proxy/` | passing   | 363 / 363       | Fastify, hosts LNURL + /api/v1 |
| `archive-worker/`| builds    | 42 / 42         | Playwright + SingleFile + BUD-04 |
| `bunker/`        | passing   | 50 / 50         | NIP-46 signing service |
| `browser-extension/` | passing | 21 / 21       | Chrome/Firefox/Safari extension |
...
**Combined: 790 passing tests; 0 typecheck errors.**
