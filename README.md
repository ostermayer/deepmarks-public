...
| ---------------- | --------- | --------------- | ----- |
| `frontend/`      | ✅ 0 err  | ✅ **301 / 301** | SvelteKit SPA, Cloudflare Pages |
...
| `browser-extension/` | ✅ 0 err | ✅ **20 / 20** | Chrome/Firefox/Safari extension |
...
**Combined: 711 passing tests; 0 typecheck errors.**
