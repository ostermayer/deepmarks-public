...
| ---------------- | --------- | --------------- | ----- |
| `frontend/`      | passing   | 377 / 377       | SvelteKit SPA, Cloudflare Pages |
| `payment-proxy/` | passing   | 373 / 373       | Fastify, hosts LNURL + /api/v1 |
| `archive-worker/`| builds    | 52 / 52         | Playwright + SingleFile + BUD-04 |
| `bunker/`        | passing   | 50 / 50         | NIP-46 signing service |
| `browser-extension/` | passing | 23 / 23       | Chrome/Firefox/Safari extension |
...
**Combined: 875 passing tests; 0 typecheck errors.**
