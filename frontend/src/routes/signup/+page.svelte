<script lang="ts">
  ...
  function buildBackupText(npub: string, nsec: string): string {
    return [
      ...
      `npub: ${npub}`,
      ``,
      `# Recovery key. Keep private. Anyone holding it controls the account forever.`,
...
<div class="page">
  ...
  {:else if step === 'new-generated'}
    ...
    <div class="key warn">
      ...
      <p class="hint">
        save this in your password manager or on paper. if you lose access to this browser
