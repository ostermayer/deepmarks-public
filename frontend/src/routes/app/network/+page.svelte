...
<Subheader
  ...
  sorts={[
    { label: 'recent', href: '#', current: true },
    { label: 'popular', href: '/app/popular' },
    { label: '⚡ most sats', href: '#' },
    { label: 'archives', href: '#' }
  ]}
/>

<BookmarkList bookmarks={$feed} loading={true} emptyMessage="no public bookmarks yet — be first" tagScope="network" />
