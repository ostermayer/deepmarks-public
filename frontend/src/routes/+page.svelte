<script lang="ts">
  ...
  let nativeSessionChecking = nativeShell;
  let showAuthChoices = false;
  ...
  onMount(() => {
    ...
    if (isNativeShell()) {
      nativeSessionChecking = true;
      showAuthChoices = false;
      void (async () => {
...
{#if nativeShell && nativeSessionChecking}
  <main
    class="home-shell native-boot"
    class:android={platform === 'android'}
    data-native-scroll-root={platform === 'android' ? 'true' : undefined}
  >
    <section class="native-boot-state" aria-live="polite">
      <Logo size={28} />
      <span>opening Deepmarks...</span>
    </section>
  </main>
{:else}
  <main
  ...
  <section class="live" class:native={nativeShell}>
    <div class="live-col">
      <div class="col-head">
        ...
        <span class="col-actions">
          <FeedIconLink href="/feed/recent.xml" label="Deepmarks recent feed" />
    ...
    <div class="live-col">
      <div class="col-head">
        <h3>popular</h3>
        <span class="col-actions">
          <FeedIconLink href="/feed/popular.xml" label="Deepmarks popular feed" />
