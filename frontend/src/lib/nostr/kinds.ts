// Nostr event kinds used by Deepmarks. Keep this aligned with the relay
// write-policy whitelist.
...
export const KIND = {
  ...
  zapRequest: 9734,
  /** NIP-57 zap receipt (signed by the recipient's LNURL service) */
  zapReceipt: 9735,
  ...
  /** NIP-65 relay list */
  relayList: 10002,
  /** Blossom BUD-03 user-server list (not a NIP) */
  blossomServers: 10063,
  /** NIP-51 categorized follow set — used for the user's Deepmarks friends subset */
  followSet: 30000,
