...
describe('saveBookmark', () => {
  it('uses a caller-provided save time for public bookmark tags and optimistic state', async () => {
    mockedPublishEvent.mockResolvedValue({ eventId: 'evt-public', relays: ['wss://relay.deepmarks.org'] });
    ...
    const publishedTemplate = mockedPublishEvent.mock.calls[0]?.[0] as UnsignedEventTemplate;
