...
export const AccountDeleteResponseSchema = z.object({
  ...
  // Email-era fields: the server now returns compatibility constants
  // (0/false) and will eventually drop them — optional so future
  // removal can't break deletion again (2026-08-23 cleanup review #1).
  privateMarksRemoved: z.number().optional(),
  passkeysRemoved: z.number().optional(),
  ciphertextRemoved: z.boolean().optional(),
  hadAccount: z.boolean().optional(),
