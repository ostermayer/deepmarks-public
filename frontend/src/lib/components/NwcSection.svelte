...
<SettingsSection title="lightning wallet (NWC)">
  {#if conn}
    <p class="settings-section-copy">
      ...
      with no QR scanning. The connection syncs encrypted to your other
      Deepmarks apps and extensions.
    </p>
    <div class="row">
  ...
  {:else}
    <p class="settings-section-copy">
      ...
      {#if storageMode === 'extension'}
        the secret is encrypted in your Deepmarks extension and synced to your
        Deepmarks apps with NIP-44 encryption.
      {:else}
        the secret is encrypted locally and synced to your other Deepmarks apps
