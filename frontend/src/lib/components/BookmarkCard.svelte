<script lang="ts">
  ...
  import { describeLinkPreview, isLikelyBlossomBlobUrl, readableHost } from '$lib/metadata/link-preview';
  ...
  $: showLinkPreview = isNostrNoteLink || isDirectMediaPreview || isBlossomBlobPreview;
  ...
  <div class="body">
    ...
    {#if showLinkPreview}
      <SocialLinkPreview
        ...
        fetchMetadata={isNostrNoteLink || isBlossomBlobPreview}
