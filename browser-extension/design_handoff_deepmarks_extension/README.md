...
- **Archiving** — lifetime members see an "Archive new bookmarks by default" toggle. Non-lifetime users see a lifetime-upgrade prompt on web builds and no archive control in Apple builds. Storage card at bottom: `248 snapshots · 412 MB · manage →`.
