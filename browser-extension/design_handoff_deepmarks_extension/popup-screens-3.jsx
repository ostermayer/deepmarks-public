          ...
          {tab === 'archive' && (
            <div>
              ...
              <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <Setting label="Lifetime archives" sub="Archiving appears here only after lifetime membership is verified.">
                  <span style={{ fontSize: 12, color: dm.muted }}>included</span>
                </Setting>
              </div>
