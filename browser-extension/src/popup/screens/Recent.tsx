...
function shouldReplace(existing: ParsedBookmark, incoming: ParsedBookmark): boolean {
  ...
  // Canonical rule (mirror of frontend bookmarks.ts
  // replaceableBookmarkWins): NIP-01 relay retention keeps the LOWEST
  // event id on a full tie — pick the same winner as every other surface.
