...
/** List the user's shipped archives newest first. NIP-98 auth so the
 *  signed-in nsec holder can list their own; the lifetime-only Bearer
 *  path at /api/v1/archives is the same data shape for script users. */
