...
| Tier | What | Where |
|---|---|---|
| 1 | App-level alerts (uncaught 5xx, BTCPay anomalies, archive-callback owner mismatch, Voltage circuit trip, archive-enqueue rollback) | `api/src/alerter.ts` — debounced via Redis, integrated into route handlers |
