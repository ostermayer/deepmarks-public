...
// Exported: search + api-v1 filter on this exact set — they used to read a
// 'dm:blocked-events' key nothing ever wrote, so admin delisting was a
// no-op for search surfaces (2026-08-23 review #4).
export const DELISTED_EVENTS = 'dm:delisted-events';
 ...
 * read/write, every archive enqueue.
 *
