...
export async function enrichMetadataInline(
  ...
  // Inline (save-form autofill) is user-facing: keep a short per-call cap so
  // the web save form stays snappy and falls back to page metadata if the
  // model is slow. The background enrichment worker uses the full chat timeout.
