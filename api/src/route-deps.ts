...
import type { MediaArchiveAddonStore } from './media-archive-addon.js';
...
import type { ArchiveRescueSearchClient } from './archive-rescue-search.js';
...
export interface Deps {
  ...
  mediaArchiveAddonStore: MediaArchiveAddonStore;
  ...
  archiveRescueSearch: ArchiveRescueSearchClient;
  ...
  ARCHIVE_WORKER_PUBKEY: string | null;
