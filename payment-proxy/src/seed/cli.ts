...
async function main(): Promise<void> {
  ...
  // The daily importer signs kind:39701 + kind:1 as the public-profile
  // identity, which production exposes through the legacy "personal"
  // bunker role. The Box C bunker has to be reachable from wherever
  ...
  const signer = new BunkerSigner({
    identityPubkey: signerConfig.personalPubkey,
