...
async function start(): Promise<void> {
  ...
  adminDashboard.register(deps, workers);
  ...
  const shutdown = async (signal: string): Promise<void> => {
    ...
    try {
      ...
      await Promise.allSettled([
        ...
        workers.relayFanout.stop(),
        workers.onboardingScanner.stop(),
        workers.lifetimeArchiveBackfill.stop(),
        workers.followsIngester.stop(),
      ]);
      await app.close();
