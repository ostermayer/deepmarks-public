...
import { detectFormat, findImporter } from '$lib/importers/index.js';
...
describe('detectFormat', () => {
  ...
  it('sniffs Deepmarks, Pocket, Instapaper, and Raindrop CSV by header', () => {
    expect(detectFormat('a.csv', 'url,title,description,tags,saved_at,archived_forever\n')?.id).toBe('csv');
