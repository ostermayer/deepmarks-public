...
```bash
./scripts/publish-public.sh --dry-run --keep-export --tag-version --version 0.8.1 -m "Prepare Deepmarks public release"
```
...
```bash
./scripts/publish-public.sh --tag-version --version 0.8.1 -m "Prepare Deepmarks public release"
```
