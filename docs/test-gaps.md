...
| `archive-worker/src/` | 13 | 8 | crypto/Blossom/Wayback/mirrors/media/scholarly helpers covered; queue/worker thin |
...
Current verification count: 373 payment-proxy tests, 377 frontend tests,
50 bunker tests, 52 archive-worker tests, and 23 browser-extension tests,
for **875 tests** total.
