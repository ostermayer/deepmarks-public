...
|---|---:|---:|---|
| `payment-proxy/src/` | 86 | 28 | broad helper coverage; route-module wiring still thin |
| `archive-worker/src/` | 12 | 7 | crypto/Blossom/Wayback/mirrors/media helpers covered; queue/worker thin |
...
Current verification count: 309 payment-proxy tests, 314 frontend tests,
50 bunker tests, 42 archive-worker tests, and 21 browser-extension tests,
for **736 tests** total.
