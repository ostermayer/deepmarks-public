...
be audited and built by contributors. For the 0.6.0 public release, the
mobile apps are **not** release artifacts and should not be treated as
store-ready. The source is documented in [`mobile.md`](mobile.md), but
the public release is web, server, docs, and browser-extension focused.
