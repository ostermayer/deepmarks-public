...
Android is in testing/Zapstore preparation, and both native shells share
the same signed-event publish model as the web app. Store-specific
payment rules matter: iOS hides Lightning checkout controls, while web
and Android can use BTCPay-hosted upgrade flows. See [`mobile.md`](mobile.md).
