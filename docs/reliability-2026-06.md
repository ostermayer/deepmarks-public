...
> **Snapshot as of June 2026.** This is the record of that program; some
> version numbers and counts below are point-in-time. For the live test
> catalog see [`../tests/README.md`](../tests/README.md).
