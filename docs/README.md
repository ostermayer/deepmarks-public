...
**Standing rule:** every production bug or operational incident gets a
dated report in [`incidents/`](incidents/README.md), written when it is
resolved — template and criteria in that directory's README.
...
| [`test-gaps.md`](test-gaps.md) | Historical pre-reliability-program coverage snapshot (superseded by [`tests/README.md`](../tests/README.md) for coverage catalog, [`reliability-2026-06.md`](reliability-2026-06.md) for current posture) |
...
| [`robustness-review-2026-08-23.md`](robustness-review-2026-08-23.md) | August 2026 full-codebase review: ~40 verified defects fixed across all four packages, plus the deferred-design and simplification backlog |
...
| [`incidents/`](incidents/README.md) | Dated incident reports — one per production bug or operational incident, written at resolution time. The directory README holds the template and the when-to-write rule |
...
| [`release.md`](release.md) | Public-mirror prep, GPL, Android/iOS, browser-extension packaging, and Zapstore release checklists |
| [`zapstore.md`](zapstore.md) | Android APK build and Zapstore publish checklist |
| [`lightning.md`](lightning.md) | LND, BTCPay, bookmark zaps, lifetime tier, multi-LN addresses |
...
| [`api-v1.md`](api-v1.md) | Public REST API for lifetime-tier members — NIP-98 + Bearer auth, every endpoint, error model, rate limits |
...
- **Public source / server** — latest
  [`v1.0.0`](releases/v1.0.0.md), the stable 1.0 milestone; history
  covers v0.6.0–v0.6.5, v0.7.0–v0.7.6, v0.8.0–v0.8.1, v0.9.0, and v1.0.0.
- **Android / Zapstore** — latest
  [`android-2.2.13`](releases/android-2.2.13.md); history runs android-1.2
  through android-2.2.13.
